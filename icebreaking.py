...
def run_quiz():
    ...
    if st.button("Submit Quiz"):
        ...
        # Displaying overall scores with Plotly visualization
        st.subheader("Leaderboard")
        score_data = load_scores()
        fig = px.bar(score_data.sort_values(by='Score', ascending=False), 
                     x='Name', y='Score', color='Score', 
                     title="Quiz Scores Leaderboard")
